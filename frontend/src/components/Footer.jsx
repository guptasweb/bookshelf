        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-400 text-sm leading-relaxed max-w-md">
              Your personal digital library for discovering, tracking, and reviewing books. 
              Powered by Google Books API with millions of titles at your fingertips.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/reading-lists" className="text-gray-400 hover:text-white transition-colors duration-200 text-sm">
                  Reading Lists
                </Link>
              </li>
              <li>
